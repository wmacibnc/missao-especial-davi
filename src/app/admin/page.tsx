    ...
    <div style={{ minHeight: '100vh', background: '#06142A' }}>
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '32px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '24px', marginBottom: '32px' }}>
          <div style={{ background: '#0B1F3D', padding: '24px', borderRadius: '8px', border: '1px solid rgba(215,182,93,0.3)' }}><div style={{ fontSize: '36px', fontWeight: 'bold', color: '#D7B65D' }}>{stats.total}</div><div style={{ color: 'white' }}>Total Convidados</div></div>
          <div style={{ background: '#0B1F3D', padding: '24px', borderRadius: '8px', border: '1px solid rgba(74,222,128,0.3)' }}><div style={{ fontSize: '36px', fontWeight: 'bold', color: '#4ade80' }}>{stats.confirmados}</div><div style={{ color: 'white' }}>Confirmados</div></div>
          <div style={{ background: '#0B1F3D', padding: '24px', borderRadius: '8px', border: '1px solid rgba(250,204,21,0.3)' }}><div style={{ fontSize: '36px', fontWeight: 'bold', color: '#facc15' }}>{stats.pendentes}</div><div style={{ color: 'white' }}>Pendentes</div></div>
          <div style={{ background: '#0B1F3D', padding: '24px', borderRadius: '8px', border: '1px solid rgba(96,165,250,0.3)' }}><div style={{ fontSize: '36px', fontWeight: 'bold', color: '#60a5fa' }}>{stats.taxa}%</div><div style={{ color: 'white' }}>Taxa Confirmação</div></div>
        </div>
